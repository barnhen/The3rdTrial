...
void Player::implementDraw() const
{
	al_draw_filled_rectangle(boundingBox.getX(), boundingBox.getY(),boundingBox.getX() + boundingBox.getWidth(),boundingBox.getY() + boundingBox.getHeight(), al_map_rgba(255,0,255,100)); // works too 
}
